          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number" style="color:blue">49.8<small>M</small></span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number" style="color:blue">1.93<small>M</small></span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number" style="color:blue">37.97<small>M</small></span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
            ...
            <div class="card">
              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-md-8">
                    <p class="text-center">
                      <strong>Cases & Recoveries: 1 Jan, 2020 - 30 Jul, 2020</strong>
                    </p>
                  ...
                  <div class="col-md-4">
                    ...
                    <div class="progress-group">
                      Avail More Ventilators to the Public
                    ...
                    <!-- /.progress-group -->
                    <div class="progress-group">
                      <span class="progress-text">Reduce Deaths</span>
